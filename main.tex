...
\begin{frame}
	...
	\begin{itemize}
	    ...
	    \item $a\mapsto na$ isogeny, étale in char.~zero \cite[Thm.~7.2]{mil08}.
	\end{itemize}
    \end{tcolorbox}
    \pause
    Last example $\Rightarrow A_{n}:=\ker(a\mapsto na)$ is finite, and being isogenous is an equivalence relation \cite[Rem.~8.6]{mil08}.
\end{frame}
